...
func (c *sglangSchedulerClient) GetTokenizer(ctx context.Context, in *common.GetTokenizerRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[common.GetTokenizerChunk], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type SglangScheduler_GetTokenizerClient = grpc.ServerStreamingClient[common.GetTokenizerChunk]

func (c *sglangSchedulerClient) SubscribeKvEvents(ctx context.Context, in *common.SubscribeKvEventsRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[common.KvEventBatch], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type SglangScheduler_SubscribeKvEventsClient = grpc.ServerStreamingClient[common.KvEventBatch]
...
func (UnimplementedSglangSchedulerServer) GetTokenizer(*common.GetTokenizerRequest, grpc.ServerStreamingServer[common.GetTokenizerChunk]) error {
	return status.Error(codes.Unimplemented, "method GetTokenizer not implemented")
}
func (UnimplementedSglangSchedulerServer) SubscribeKvEvents(*common.SubscribeKvEventsRequest, grpc.ServerStreamingServer[common.KvEventBatch]) error {
...
func RegisterSglangSchedulerServer(s grpc.ServiceRegistrar, srv SglangSchedulerServer) {
	// If the following call panics, it indicates UnimplementedSglangSchedulerServer was
...
func _SglangScheduler_GetTokenizer_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(SglangSchedulerServer).GetTokenizer(m, &grpc.GenericServerStream[common.GetTokenizerRequest, common.GetTokenizerChunk]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type SglangScheduler_GetTokenizerServer = grpc.ServerStreamingServer[common.GetTokenizerChunk]
...
func _SglangScheduler_SubscribeKvEvents_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(SglangSchedulerServer).SubscribeKvEvents(m, &grpc.GenericServerStream[common.SubscribeKvEventsRequest, common.KvEventBatch]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type SglangScheduler_SubscribeKvEventsServer = grpc.ServerStreamingServer[common.KvEventBatch]
