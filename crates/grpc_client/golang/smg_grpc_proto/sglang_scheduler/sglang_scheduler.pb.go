...
func (x *AggregateMetrics) Reset() {
	*x = AggregateMetrics{}
	mi := &file_sglang_scheduler_proto_msgTypes[47]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AggregateMetrics) Descriptor() ([]byte, []int) {
	return file_sglang_scheduler_proto_rawDescGZIP(), []int{47}
}
...
const file_sglang_scheduler_proto_rawDesc = "" +
	...
	"\x06length\x18\x02 \x01(\rR\x06length\"\x86\x02\n" +
...
var file_sglang_scheduler_proto_msgTypes = make([]protoimpl.MessageInfo, 50)
var file_sglang_scheduler_proto_goTypes = []any{
	...
	(*GenerateError)(nil),                   // 10: sglang.grpc.scheduler.GenerateError
	(*OutputLogProbs)(nil),                  // 11: sglang.grpc.scheduler.OutputLogProbs
	(*InputLogProbs)(nil),                   // 12: sglang.grpc.scheduler.InputLogProbs
	(*InputTokenLogProb)(nil),               // 13: sglang.grpc.scheduler.InputTokenLogProb
	(*TopLogProbs)(nil),                     // 14: sglang.grpc.scheduler.TopLogProbs
	(*HiddenStates)(nil),                    // 15: sglang.grpc.scheduler.HiddenStates
	(*EmbedRequest)(nil),                    // 16: sglang.grpc.scheduler.EmbedRequest
	(*EmbedResponse)(nil),                   // 17: sglang.grpc.scheduler.EmbedResponse
	(*EmbedComplete)(nil),                   // 18: sglang.grpc.scheduler.EmbedComplete
	(*Embedding)(nil),                       // 19: sglang.grpc.scheduler.Embedding
	(*EmbedError)(nil),                      // 20: sglang.grpc.scheduler.EmbedError
	(*HealthCheckRequest)(nil),              // 21: sglang.grpc.scheduler.HealthCheckRequest
	(*HealthCheckResponse)(nil),             // 22: sglang.grpc.scheduler.HealthCheckResponse
	(*AbortRequest)(nil),                    // 23: sglang.grpc.scheduler.AbortRequest
	(*AbortResponse)(nil),                   // 24: sglang.grpc.scheduler.AbortResponse
	(*LoadLoRARequest)(nil),                 // 25: sglang.grpc.scheduler.LoadLoRARequest
	(*LoadLoRAResponse)(nil),                // 26: sglang.grpc.scheduler.LoadLoRAResponse
	(*UnloadLoRARequest)(nil),               // 27: sglang.grpc.scheduler.UnloadLoRARequest
	(*UnloadLoRAResponse)(nil),              // 28: sglang.grpc.scheduler.UnloadLoRAResponse
	(*UpdateWeightsRequest)(nil),            // 29: sglang.grpc.scheduler.UpdateWeightsRequest
	(*UpdateWeightsResponse)(nil),           // 30: sglang.grpc.scheduler.UpdateWeightsResponse
	(*GetInternalStateRequest)(nil),         // 31: sglang.grpc.scheduler.GetInternalStateRequest
	(*GetInternalStateResponse)(nil),        // 32: sglang.grpc.scheduler.GetInternalStateResponse
	(*SetInternalStateRequest)(nil),         // 33: sglang.grpc.scheduler.SetInternalStateRequest
	(*SetInternalStateResponse)(nil),        // 34: sglang.grpc.scheduler.SetInternalStateResponse
	(*GetModelInfoRequest)(nil),             // 35: sglang.grpc.scheduler.GetModelInfoRequest
	(*GetModelInfoResponse)(nil),            // 36: sglang.grpc.scheduler.GetModelInfoResponse
	(*GetServerInfoRequest)(nil),            // 37: sglang.grpc.scheduler.GetServerInfoRequest
	(*GetServerInfoResponse)(nil),           // 38: sglang.grpc.scheduler.GetServerInfoResponse
	(*GetLoadsRequest)(nil),                 // 39: sglang.grpc.scheduler.GetLoadsRequest
	(*GetLoadsResponse)(nil),                // 40: sglang.grpc.scheduler.GetLoadsResponse
	(*SchedulerLoad)(nil),                   // 41: sglang.grpc.scheduler.SchedulerLoad
	(*MemoryMetrics)(nil),                   // 42: sglang.grpc.scheduler.MemoryMetrics
	(*SpeculativeMetrics)(nil),              // 43: sglang.grpc.scheduler.SpeculativeMetrics
	(*LoRAMetrics)(nil),                     // 44: sglang.grpc.scheduler.LoRAMetrics
	(*DisaggregationMetrics)(nil),           // 45: sglang.grpc.scheduler.DisaggregationMetrics
	(*QueueMetrics)(nil),                    // 46: sglang.grpc.scheduler.QueueMetrics
	(*AggregateMetrics)(nil),                // 47: sglang.grpc.scheduler.AggregateMetrics
	nil,                                     // 48: sglang.grpc.scheduler.SamplingParams.LogitBiasEntry
	nil,                                     // 49: sglang.grpc.scheduler.MultimodalInputs.ModelSpecificTensorsEntry
	(*structpb.Struct)(nil),                 // 50: google.protobuf.Struct
	(*timestamppb.Timestamp)(nil),           // 51: google.protobuf.Timestamp
	(*common.GetTokenizerRequest)(nil),      // 52: smg.grpc.common.GetTokenizerRequest
	(*common.SubscribeKvEventsRequest)(nil), // 53: smg.grpc.common.SubscribeKvEventsRequest
	(*common.GetTokenizerChunk)(nil),        // 54: smg.grpc.common.GetTokenizerChunk
	(*common.KvEventBatch)(nil),             // 55: smg.grpc.common.KvEventBatch
}
var file_sglang_scheduler_proto_depIdxs = []int32{
	48, // 0: sglang.grpc.scheduler.SamplingParams.logit_bias:type_name -> sglang.grpc.scheduler.SamplingParams.LogitBiasEntry
	50, // 1: sglang.grpc.scheduler.SamplingParams.custom_params:type_name -> google.protobuf.Struct
	...
	51, // 6: sglang.grpc.scheduler.GenerateRequest.timestamp:type_name -> google.protobuf.Timestamp
	4,  // 7: sglang.grpc.scheduler.MultimodalInputs.pixel_values:type_name -> sglang.grpc.scheduler.TensorData
	49, // 8: sglang.grpc.scheduler.MultimodalInputs.model_specific_tensors:type_name -> sglang.grpc.scheduler.MultimodalInputs.ModelSpecificTensorsEntry
	...
	10, // 12: sglang.grpc.scheduler.GenerateResponse.error:type_name -> sglang.grpc.scheduler.GenerateError
	11, // 13: sglang.grpc.scheduler.GenerateStreamChunk.output_logprobs:type_name -> sglang.grpc.scheduler.OutputLogProbs
	12, // 14: sglang.grpc.scheduler.GenerateStreamChunk.input_logprobs:type_name -> sglang.grpc.scheduler.InputLogProbs
	11, // 15: sglang.grpc.scheduler.GenerateComplete.output_logprobs:type_name -> sglang.grpc.scheduler.OutputLogProbs
	15, // 16: sglang.grpc.scheduler.GenerateComplete.all_hidden_states:type_name -> sglang.grpc.scheduler.HiddenStates
	12, // 17: sglang.grpc.scheduler.GenerateComplete.input_logprobs:type_name -> sglang.grpc.scheduler.InputLogProbs
	14, // 18: sglang.grpc.scheduler.OutputLogProbs.top_logprobs:type_name -> sglang.grpc.scheduler.TopLogProbs
	13, // 19: sglang.grpc.scheduler.InputLogProbs.token_logprobs:type_name -> sglang.grpc.scheduler.InputTokenLogProb
	14, // 20: sglang.grpc.scheduler.InputLogProbs.top_logprobs:type_name -> sglang.grpc.scheduler.TopLogProbs
	3,  // 21: sglang.grpc.scheduler.EmbedRequest.tokenized:type_name -> sglang.grpc.scheduler.TokenizedInput
	5,  // 22: sglang.grpc.scheduler.EmbedRequest.mm_inputs:type_name -> sglang.grpc.scheduler.MultimodalInputs
	0,  // 23: sglang.grpc.scheduler.EmbedRequest.sampling_params:type_name -> sglang.grpc.scheduler.SamplingParams
	18, // 24: sglang.grpc.scheduler.EmbedResponse.complete:type_name -> sglang.grpc.scheduler.EmbedComplete
	20, // 25: sglang.grpc.scheduler.EmbedResponse.error:type_name -> sglang.grpc.scheduler.EmbedError
	19, // 26: sglang.grpc.scheduler.EmbedComplete.batch_embeddings:type_name -> sglang.grpc.scheduler.Embedding
	50, // 27: sglang.grpc.scheduler.GetInternalStateResponse.state:type_name -> google.protobuf.Struct
	50, // 28: sglang.grpc.scheduler.SetInternalStateRequest.state:type_name -> google.protobuf.Struct
	50, // 29: sglang.grpc.scheduler.GetServerInfoResponse.server_args:type_name -> google.protobuf.Struct
	50, // 30: sglang.grpc.scheduler.GetServerInfoResponse.scheduler_info:type_name -> google.protobuf.Struct
	51, // 31: sglang.grpc.scheduler.GetServerInfoResponse.start_time:type_name -> google.protobuf.Timestamp
	41, // 32: sglang.grpc.scheduler.GetLoadsResponse.loads:type_name -> sglang.grpc.scheduler.SchedulerLoad
	47, // 33: sglang.grpc.scheduler.GetLoadsResponse.aggregate:type_name -> sglang.grpc.scheduler.AggregateMetrics
	42, // 34: sglang.grpc.scheduler.SchedulerLoad.memory:type_name -> sglang.grpc.scheduler.MemoryMetrics
	43, // 35: sglang.grpc.scheduler.SchedulerLoad.speculative:type_name -> sglang.grpc.scheduler.SpeculativeMetrics
	44, // 36: sglang.grpc.scheduler.SchedulerLoad.lora:type_name -> sglang.grpc.scheduler.LoRAMetrics
	45, // 37: sglang.grpc.scheduler.SchedulerLoad.disaggregation:type_name -> sglang.grpc.scheduler.DisaggregationMetrics
	46, // 38: sglang.grpc.scheduler.SchedulerLoad.queues:type_name -> sglang.grpc.scheduler.QueueMetrics
	4,  // 39: sglang.grpc.scheduler.MultimodalInputs.ModelSpecificTensorsEntry.value:type_name -> sglang.grpc.scheduler.TensorData
	2,  // 40: sglang.grpc.scheduler.SglangScheduler.Generate:input_type -> sglang.grpc.scheduler.GenerateRequest
	16, // 41: sglang.grpc.scheduler.SglangScheduler.Embed:input_type -> sglang.grpc.scheduler.EmbedRequest
	21, // 42: sglang.grpc.scheduler.SglangScheduler.HealthCheck:input_type -> sglang.grpc.scheduler.HealthCheckRequest
	23, // 43: sglang.grpc.scheduler.SglangScheduler.Abort:input_type -> sglang.grpc.scheduler.AbortRequest
	35, // 44: sglang.grpc.scheduler.SglangScheduler.GetModelInfo:input_type -> sglang.grpc.scheduler.GetModelInfoRequest
	37, // 45: sglang.grpc.scheduler.SglangScheduler.GetServerInfo:input_type -> sglang.grpc.scheduler.GetServerInfoRequest
	39, // 46: sglang.grpc.scheduler.SglangScheduler.GetLoads:input_type -> sglang.grpc.scheduler.GetLoadsRequest
	52, // 47: sglang.grpc.scheduler.SglangScheduler.GetTokenizer:input_type -> smg.grpc.common.GetTokenizerRequest
	53, // 48: sglang.grpc.scheduler.SglangScheduler.SubscribeKvEvents:input_type -> smg.grpc.common.SubscribeKvEventsRequest
	7,  // 49: sglang.grpc.scheduler.SglangScheduler.Generate:output_type -> sglang.grpc.scheduler.GenerateResponse
	17, // 50: sglang.grpc.scheduler.SglangScheduler.Embed:output_type -> sglang.grpc.scheduler.EmbedResponse
	22, // 51: sglang.grpc.scheduler.SglangScheduler.HealthCheck:output_type -> sglang.grpc.scheduler.HealthCheckResponse
	24, // 52: sglang.grpc.scheduler.SglangScheduler.Abort:output_type -> sglang.grpc.scheduler.AbortResponse
	36, // 53: sglang.grpc.scheduler.SglangScheduler.GetModelInfo:output_type -> sglang.grpc.scheduler.GetModelInfoResponse
	38, // 54: sglang.grpc.scheduler.SglangScheduler.GetServerInfo:output_type -> sglang.grpc.scheduler.GetServerInfoResponse
	40, // 55: sglang.grpc.scheduler.SglangScheduler.GetLoads:output_type -> sglang.grpc.scheduler.GetLoadsResponse
	54, // 56: sglang.grpc.scheduler.SglangScheduler.GetTokenizer:output_type -> smg.grpc.common.GetTokenizerChunk
	55, // 57: sglang.grpc.scheduler.SglangScheduler.SubscribeKvEvents:output_type -> smg.grpc.common.KvEventBatch
...
func file_sglang_scheduler_proto_init() {
	...
	file_sglang_scheduler_proto_msgTypes[13].OneofWrappers = []any{}
	file_sglang_scheduler_proto_msgTypes[17].OneofWrappers = []any{
		(*EmbedResponse_Complete)(nil),
		(*EmbedResponse_Error)(nil),
	}
	file_sglang_scheduler_proto_msgTypes[29].OneofWrappers = []any{
	...
	file_sglang_scheduler_proto_msgTypes[41].OneofWrappers = []any{}
	type x struct{}
